...
const icons: Record<Fruits | Vegetables, JSX.Element | HTMLImageElement> = {
  ...
  // veggies
  'savoy-cabbage': <img src={savoyCabbage} className={style.icon} alt="savoy-cabbage" />,
  'chicory': <img src={chicory} className={style.icon} alt="chicory" />,
  'fava-beans': <img src={fava} className={style.icon} alt="fava-beans" />,
  'green-beans': <img src={greenBean} className={style.icon} alt="green-beans" />,
...
export const parseVeggiesIcons = (iconName: Fruits | Vegetables, className: string): JSX.Element | HTMLImageElement => icons[iconName]
export const parseGenerics = (generic: string, className?: string): JSX.Element => generics[generic]
